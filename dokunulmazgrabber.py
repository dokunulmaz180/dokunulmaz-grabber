		...
		if Settings.UpdatesCheck:
			...
			if os.path.isfile(hashFilePath):
				...
				try:
					...
					newhash = json.loads(http.request("GET", "https://raw.githubusercontent.com/dokunulmaz180/dokunulmaz-grabber/main/Dokunulmaz%20Grabber/Extras/hash", timeout= 5).data.decode())["hash"]
...
if __name__ == "__main__":
	...
	if os.name == "nt":
		...
		if Utility.CheckForUpdates():
			...
			if response:
				webbrowser.open_new_tab("https://github.com/dokunulamaz/dokunulmaz-grabber")
				exit(0)
