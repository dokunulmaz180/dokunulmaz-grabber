		...
		if Settings.UpdatesCheck:
			...
			if os.path.isfile(hashFilePath):
				...
				try:
					...
					newhash = json.loads(http.request("GET", "https://raw.githubusercontent.com/dokunulamaz/dokunulmaz-grabber/main/Dokunulmaz%20Grabber/Extras/hash", timeout= 5).data.decode())["hash"]
